    ...
    <div className="home-container">
      ...
      <section className="hero-section">
        ...
        <div className="hero-center">
          ...
          <div className="hero-buttons">
            <Link to="/upload" className="btn main-btn">إضافة تبرع</Link>
            <Link to="/items" className="btn secondary-btn">معرض التبرعات</Link>
          </div>
        </div>
      </section>
      ...
      <section className="content-section">
        ...
        <div className="box">
          ...
          <p>
            وقال رسول الله ﷺ: "أحب الناس إلى الله أنفعهم للناس".<br />
